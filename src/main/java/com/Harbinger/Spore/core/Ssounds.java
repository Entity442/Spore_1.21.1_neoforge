...
public class Ssounds {
    ...
    public static final Holder<SoundEvent> VERFALL_TAR_ATTACK = soundRegistry("verfall_tar_attack");

    public static final Holder<SoundEvent> VERFALL_SPECIAL_ATTACK = soundRegistry("verfall_special_attack");

    public static final Holder<SoundEvent> VERFALL_NECK_REGROW = soundRegistry("verfall_neck_regrow");

    public static final Holder<SoundEvent> VERFALL_HEAD_REGROW = soundRegistry("verfall_head_regrow");

    public static final Holder<SoundEvent> VERFALL_ATTACK = soundRegistry("verfall_attack");
