...
public class InfectedPlayerRenderer extends BaseInfectedRenderer<InfectedPlayer , HumanoidModel<InfectedPlayer>> {
    ...
    public static final Map<Component,ResourceLocation> SPECIAL_SKINS =new HashMap<>(){{
        ...
        put(Component.literal("DivnejFelix"), ResourceLocation.fromNamespaceAndPath(Spore.MODID,
                "textures/entity/player/penguin.png"));
        put(Component.literal("The_Harbinger69"), ResourceLocation.fromNamespaceAndPath(Spore.MODID,
                "textures/entity/player/harby.png"));
        put(Component.literal("hammbug"), ResourceLocation.fromNamespaceAndPath(Spore.MODID,
