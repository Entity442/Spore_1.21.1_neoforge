...
public class StingerRenderer <T extends StingerProjectile>extends EntityRenderer<T> {
    public static final ResourceLocation LOCATION =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/stinger.png");
    public static final ResourceLocation SPIKE =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/spike.png");
