...
public class AcidBulletRenderer extends EntityRenderer<AssassinBullet> {
    public static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/acid_round.png");
    ...
    public static class AcidRound<T extends AssassinBullet> extends EntityModel<T> {
        ...
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "acidround"), "main");
        ...
        public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
            AcidRound.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
        }
    }
}