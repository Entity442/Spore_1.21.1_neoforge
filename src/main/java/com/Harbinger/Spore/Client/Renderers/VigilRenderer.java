...
public class VigilRenderer<Type extends Vigil> extends OrganoidMobRenderer<Type , EntityModel<Type>> {
    ...
    private static final ResourceLocation STALKER =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,
            "textures/entity/vigil_stalker.png");
    private static final ResourceLocation RINGER =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,
