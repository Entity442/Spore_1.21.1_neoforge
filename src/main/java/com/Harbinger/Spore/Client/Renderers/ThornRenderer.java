    ...
    public static final Map<ThornVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(ThornVariants.class), (p_114874_) -> {
                p_114874_.put(ThornVariants.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/vervathorn.png"));
                p_114874_.put(ThornVariants.TOXIC,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/toxic_vervathorn.png"));
                p_114874_.put(ThornVariants.CACTUS,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/cactus_verva.png"));
                p_114874_.put(ThornVariants.SKEWER,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/verdathorn_skewerer.png"));
                p_114874_.put(ThornVariants.ROLLER,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/roller_verva.png"));
            });
