...
public class FleshBombRenderer<T extends FleshBomb>extends EntityRenderer<T> {
    public static final ResourceLocation BASIC_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/basicround.png");
    public static final ResourceLocation FLAMMABLE_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/fireround.png");
    public static final ResourceLocation BILE_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/bileround.png");
    public static final ResourceLocation ACID_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/acidround.png");
    public static final ResourceLocation NUCLEAR_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/nuclear_round.png");
    public static final ResourceLocation BASIC_JOLLY_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/jolly_howitzer_round.png");
    public static final ResourceLocation FLAMMABLE_JOLLY_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/jolly_fire_howitzer_round.png");
    public static final ResourceLocation BILE_JOLLY_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/jolly_bile_howitzer_round.png");
    public static final ResourceLocation ACID_JOLLY_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/jolly_acid_howitzer_round.png");
    public static final ResourceLocation NUCLEAR_JOLLY_ROUND =  ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/jolly_nuke_howitzer_round.png");
    ...
    public void render(T entity, float value2, float value, PoseStack stack, MultiBufferSource source, int p_116116_) {
        ...
        entityModel.renderToBuffer(stack, vertexconsumer, p_116116_, OverlayTexture.NO_OVERLAY, -1);
        stack.popPose();
