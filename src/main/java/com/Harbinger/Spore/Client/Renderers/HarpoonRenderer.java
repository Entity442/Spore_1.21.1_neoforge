...
public class HarpoonRenderer extends EntityRenderer<HarpoonProjectile> {
    public static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/graken_ship.png");
    public static final ResourceLocation CHAIN_LOCATION = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/chains.png");
    ...
    private void renderConnection(Vec3 from, Vec3 to,int light, PoseStack stack, MultiBufferSource buffer,int index) {
        ...
        stack.pushPose();
        {
            ...
            stack.pushPose();
            {
                ...
                chains.renderToBuffer(stack,consumer,light, OverlayTexture.NO_OVERLAY, -1);
            }
            stack.popPose();
        }
        stack.popPose();
