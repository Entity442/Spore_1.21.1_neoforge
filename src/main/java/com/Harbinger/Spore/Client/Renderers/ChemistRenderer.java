    ...
    public static final Map<ChemistVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(ChemistVariants.class), (p_114874_) -> {
                p_114874_.put(ChemistVariants.DEFAULT,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/chemist.png"));
                p_114874_.put(ChemistVariants.MECHANIC,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/chemist_mechanic.png"));
                p_114874_.put(ChemistVariants.FUMING,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/pyro_chemist.png"));
                p_114874_.put(ChemistVariants.BURST,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/burst_chemist.png"));
                p_114874_.put(ChemistVariants.SPREADER,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/spreader_chemist.png"));
            });
