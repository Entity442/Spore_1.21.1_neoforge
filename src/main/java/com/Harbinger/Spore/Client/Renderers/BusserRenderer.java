    ...
    public static final Map<BusserVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(BusserVariants.class), (p_114874_) -> {
                p_114874_.put(BusserVariants.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/busser.png"));
                p_114874_.put(BusserVariants.ENHANCED,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/busser_aggressive.png"));
                p_114874_.put(BusserVariants.BOMBER,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/busserbomber.png"));
                p_114874_.put(BusserVariants.TOXIC,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/toxic_busser.png"));
                p_114874_.put(BusserVariants.TRANSPORTER,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/transported_bussy.png"));
            });
