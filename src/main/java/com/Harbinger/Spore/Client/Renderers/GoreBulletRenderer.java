...
public class GoreBulletRenderer extends EntityRenderer<GoreBullet> {
    public static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/gore_round.png");
    ...
    public static class GoreRound<T extends GoreBullet> extends EntityModel<T> {
        ...
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "goreround"), "main");
        ...
        public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
            GoreRound.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
        }
    }
}