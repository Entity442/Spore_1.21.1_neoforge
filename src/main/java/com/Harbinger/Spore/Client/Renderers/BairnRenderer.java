    ...
    public static final Map<BairnSkins, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(BairnSkins.class), (p_114874_) -> {
                p_114874_.put(BairnSkins.ZOMBIE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bairn/bairn_human.png"));
                p_114874_.put(BairnSkins.VILLAGER,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bairn/bairn_villager.png"));
                p_114874_.put(BairnSkins.DROWNED,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bairn/bairn_drowned.png"));
                p_114874_.put(BairnSkins.HUSK,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bairn/bairn_husk.png"));
                p_114874_.put(BairnSkins.ZOMBIE_VILLAGER,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bairn/bairn_zombie_villager.png"));
            });
