...
public class CduRenderer extends BaseBlockEntityRenderer<CDUBlockEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/cdu.png");
    private static final ResourceLocation TEXTURE2 = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/infested_cdu.png");
    ...
    public void render(@NotNull CDUBlockEntity blockEntity, float partialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        ...
        if (blockEntity.infested()){
            ...
            this.infestedCDU.renderToBuffer(pPoseStack,vertexConsumer,pPackedLight, pPackedOverlay,-1);
        }else {
