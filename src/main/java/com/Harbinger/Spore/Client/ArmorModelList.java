...
public class ArmorModelList {
    private static final ResourceLocation psi_glow = ResourceLocation.parse("spore:textures/item/pci_gl.png");
    private static final ResourceLocation jaw_texture = ResourceLocation.parse("spore:textures/armor/ravenous_mouth.png");
    private static final ResourceLocation laced_thorns_texture = ResourceLocation.parse("spore:textures/armor/laced_thorns.png");
    ...
    private static final livingArmorModelBase<LivingEntity> livingArmorModel = new livingArmorModelBase<>();
   ...
   public static final LeftBootArmorPart LIVING_LEFT_BOOT_PART = new LeftBootArmorPart(Sitems.LIVING_BOOTS.get().asItem(),() ->livingEntityfleshArmorModel,() ->livingEntityfleshArmorModel.leftBoot,-0.1f,-0.8f,0,1f);
    ...
    private static final HelmetArmorPartEnchant THORNS_HELMET_PART = new HelmetArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.head,0f,0f,0,1f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
    public static final RightArmArmorPartEnchant THORNS_RIGHT_ARM_PART = new RightArmArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.rightDarm,0.3f,-0.125f,0,1f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
    public static final LeftArmArmorPartEnchant THORNS_LEFT_ARM_PART =  new LeftArmArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.leftDarm,-0.3f,-0.125f,0,1f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
     public static final RightLegArmorPartEnchant THORNS_RIGHT_LEG_PART = new RightLegArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.rightDleg,0.1f,-0.8f,0,1.01f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
    public static final LeftLegArmorPartEnchant THORNS_LEFT_LEG_PART = new LeftLegArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.leftDleg,-0.1f,-0.8f,0,1f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
    public static final RightBootArmorPartEnchant THORNS_RIGHT_BOOT_PART = new RightBootArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.rightDboot,0.1f,-0.8f,0,1.01f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
    public static final LeftBootArmorPartEnchant THORNS_LEFT_BOOT_PART = new LeftBootArmorPartEnchant(() ->lacedThornsModel,() ->lacedThornsModel.leftDboot,-0.1f,-0.8f,0,1f, Senchantments.SERRATED_THORNS,laced_thorns_texture,fleshBlackList);
