...
public class MechanicChemistModel<T extends Chemist> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "mechanicchemistmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(112, 17).addBox(-1.0F, -2.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offset(5.0F, -19.0F, 0.0F));
