...
public class MossProtectorModel<T extends Protector> extends EntityModel<T> implements TentacledModel, ProtectorBits  {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "mossprotectormodel"), "main");
