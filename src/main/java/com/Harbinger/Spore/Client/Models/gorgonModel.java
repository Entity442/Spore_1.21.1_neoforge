...
public class gorgonModel<T extends Gorgon> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "gorgonmodel"), "main");
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		float val = 0.5f + (entity.getSpores() * 0.1f);
		tumor(uppersack,val);
		tumor(lowersack,val);
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		groggon.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}