...
public class hohlfresserHeadModelAdapted<T extends Hohlfresser> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "hohlfresserheadmodeladapted"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		hohl_head.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}