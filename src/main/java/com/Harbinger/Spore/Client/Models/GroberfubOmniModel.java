...
public class GroberfubOmniModel<T extends Grober> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "groberfubomnimodel"), "main");
