...
public class DragonNeckPieceElectricModel<T extends LivingEntity> extends EntityModel<T> implements ElectricalBrain{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "dragonneckpieceelectricmodel"), "main");
