...
public class ChargerBendModel<T extends Charger> extends EntityModel<T> implements TentacledModel, ChargerBits {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "chargerbendmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Charger = partdefinition.addOrReplaceChild("Charger", CubeListBuilder.create(), PartPose.offset(1.2805F, 11.0888F, 1.2361F));

		PartDefinition Legs = Charger.addOrReplaceChild("Legs", CubeListBuilder.create(), PartPose.offset(1.5695F, 12.9112F, 2.0639F));

		PartDefinition RightLeg = Legs.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-5.65F, -17.0F, 0.0F));
		...
		PartDefinition RightLegUpper_r1 = RightLegMainUpper.addOrReplaceChild("RightLegUpper_r1", CubeListBuilder.create().texOffs(40, 76).addBox(-2.0F, -3.5F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.2F, 2.5024F, -0.5909F, -0.1308F, 0.0046F, 0.0346F));
		...
		PartDefinition LeftLeg = Legs.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(-0.35F, -17.0F, 0.0F));
		...
		PartDefinition LeftLegUpper_r1 = LeftLegMainUpper.addOrReplaceChild("LeftLegUpper_r1", CubeListBuilder.create().texOffs(56, 76).addBox(-2.0F, -3.5F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.3F, 2.5024F, -0.1909F, -0.1285F, -0.0504F, -0.0501F));
		...
		PartDefinition Head = Charger.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(-1.2805F, -12.3575F, -10.3364F));
		...
		PartDefinition Torso = Charger.addOrReplaceChild("Torso", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.0714F, -5.1962F, 0.0421F, 0.48F, 0.0F, 0.0F));
		...
		PartDefinition ChestFoliage = Chest.addOrReplaceChild("ChestFoliage", CubeListBuilder.create(), PartPose.offset(1.4211F, 20.3103F, 1.7011F));
		...
		PartDefinition Armor = Torso.addOrReplaceChild("Armor", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, -1.25F));

		PartDefinition cube_r1 = Armor.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 60).addBox(-11.0F, -20.0F, -10.0F, 28.0F, 28.0F, 20.0F, new CubeDeformation(-9.25F)), PartPose.offsetAndRotation(-2.25F, 0.75F, 0.5F, 0.5236F, 0.0F, 0.0F));

		PartDefinition Arms = Charger.addOrReplaceChild("Arms", CubeListBuilder.create(), PartPose.offset(-1.3565F, -14.1798F, -1.8974F));

		PartDefinition RightArm = Arms.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-5.2177F, 3.8844F, -3.0627F));
		...
		PartDefinition LeftArm = Arms.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offset(5.2177F, 5.1156F, -2.9373F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (attackAnimationTick > 0) {
			...
			this.animateTentacleY(LeftArm,swing * 0.5f);
			this.animateTentacleY(RightArm,swing * -0.5f);
		}
	}
