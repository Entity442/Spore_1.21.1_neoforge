...
public class JollyPresentBombs<T extends FleshBomb> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "jollypresentbombs"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		RegularPresent.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}