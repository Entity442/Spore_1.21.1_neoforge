...
public class VanguardArrowLayerModel<T extends Vanguard> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "vanguardarrowlayermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		arrowLayer.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}