...
public class CollectorProtectorModel<T extends Protector> extends EntityModel<T> implements TentacledModel, ProtectorBits {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "collectorprotectormodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		...
		Protector.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
