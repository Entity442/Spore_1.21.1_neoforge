...
public class HandSeg1<T extends Entity> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "handseg1"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		BaseSegment.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		CalcifiedCorpses.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		CalcifiedThorns.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		Fingers.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}