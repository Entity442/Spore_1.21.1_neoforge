...
public class ChargerModel<T extends Charger> extends EntityModel<T> implements TentacledModel,ChargerBits {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "chargermodel"), "main");
	public final ModelPart Charger;
	...
	public ChargerModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Charger.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(-1.2805F, -17.3575F, -5.3364F));
		...
		PartDefinition Torso = Charger.addOrReplaceChild("Torso", CubeListBuilder.create(), PartPose.offset(-2.0714F, -7.1962F, 1.0421F));
		...
		PartDefinition cube_r1 = Armor.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 60).addBox(-11.0F, -20.0F, -10.0F, 28.0F, 28.0F, 20.0F, new CubeDeformation(-9.25F)), PartPose.offsetAndRotation(-2.25F, 2.75F, -0.5F, 0.5236F, 0.0F, 0.0F));

		PartDefinition Arms = Charger.addOrReplaceChild("Arms", CubeListBuilder.create(), PartPose.offset(-1.3565F, -14.1798F, -1.8974F));

		PartDefinition RightArm = Arms.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-5.2177F, -0.1156F, -0.0627F));
		...
		PartDefinition LeftArm = Arms.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offset(5.2177F, 0.1156F, 0.0627F));
