...
public class FungalDragonBodyModel<T extends Verfalldrachen> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "fungaldragonbodymodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Ribcage.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}