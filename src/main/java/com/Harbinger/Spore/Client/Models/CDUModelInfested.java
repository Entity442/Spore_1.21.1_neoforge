...
public class CDUModelInfested<T extends CDUBlockEntity> extends BlockEntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "cdumodelinfested"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		cdu.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
