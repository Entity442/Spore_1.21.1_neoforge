...
public class HollenhundRangedModel<T extends Hollenhund> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "hollenhundrangedmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		worm.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}