...
public class valkyrieGargoyleModel<T extends Gargoyl> extends EntityModel<T> implements TentacledModel, GargoyleBits{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "valkyriegargoylemodel"), "main");
