...
public class DragonNeckPieceSonicMidModel<T extends LivingEntity> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "dragonneckpiecesonicmidmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		gay.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}