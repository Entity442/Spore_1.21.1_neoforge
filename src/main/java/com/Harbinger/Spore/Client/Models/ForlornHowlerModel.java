...
public class ForlornHowlerModel<T extends Howler> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "forlornhowlermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		Howler.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}