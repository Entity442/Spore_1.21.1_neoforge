...
public class BruteModel<T extends Brute> extends EntityModel<T> implements ArmedModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "brutemodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Brute.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
	@Override
