...
public class HowitzerModel<T extends Howitzer> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "howitzer_model"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Howi.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}