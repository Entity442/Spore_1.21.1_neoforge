...
public class InfectedPillagerCaptainModel<T extends InfectedPillager> extends InfectedPillagerModel<T>{
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infectedpillagercaptainmodel"), "main");
