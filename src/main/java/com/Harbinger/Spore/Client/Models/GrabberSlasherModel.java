...
public class GrabberSlasherModel<T extends Slasher> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "grabberslashermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		yoink.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}