...
public class ScrewerSlasherModel<T extends Slasher> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "screwerslashermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Acupuncturer.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}