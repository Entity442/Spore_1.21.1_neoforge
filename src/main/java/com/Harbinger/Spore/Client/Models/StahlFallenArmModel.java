...
public class StahlFallenArmModel<T extends StalhArm> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "stahlfallenarmmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,  int alpha) {
		Evilshoulder.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}