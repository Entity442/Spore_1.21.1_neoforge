...
public class Seg9<T extends Entity> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "seg9"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		Corpses.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
		Tumor.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		Tendrils.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}