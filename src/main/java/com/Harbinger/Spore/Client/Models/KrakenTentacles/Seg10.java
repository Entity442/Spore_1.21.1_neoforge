...
public class Seg10<T extends Entity> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "seg10"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		Tumor1.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		Tumor2.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}