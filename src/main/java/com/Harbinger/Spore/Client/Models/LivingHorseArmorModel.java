...
public class LivingHorseArmorModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "livinghorsearmormodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		FrontRightLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		FrontLeftLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		BackRightLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		BackLeftLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}