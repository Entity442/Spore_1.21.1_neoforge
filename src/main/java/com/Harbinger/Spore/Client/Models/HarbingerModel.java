...
public class HarbingerModel<T extends InfectedPlayer> extends HumanoidModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "harbingermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		eye.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		...
		left_arm.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		right_arm.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		left_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
