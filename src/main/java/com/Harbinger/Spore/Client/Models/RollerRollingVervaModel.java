...
public class RollerRollingVervaModel<T extends Thorn> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "rollerrollingvervamodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		Torn.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}