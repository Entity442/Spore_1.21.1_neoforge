...
public class GorgonSpookyModel<T extends Gorgon> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "gorgonspookymodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		GorgonModel.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}