...
public class InfestedSpawnerModel<T extends OvergrownSpawnerEntity> extends BlockEntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infested_spawner"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		InfestedSpawnerRemodel.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
