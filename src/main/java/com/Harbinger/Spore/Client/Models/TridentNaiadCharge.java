...
public class TridentNaiadCharge<T extends Naiad> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "tridentnaiadcharge"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		bodySpin.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}