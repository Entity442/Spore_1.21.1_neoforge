...
public class Tar extends Block {
    ...
    public void entityInside(BlockState p_60495_, Level p_60496_, BlockPos p_60497_, Entity entity) {
        ...
        if (entity instanceof LivingEntity living && Utilities.TARGET_SELECTOR.Test(living) && !living.hasEffect(Seffects.IGNITABLE)){
            living.addEffect(new MobEffectInstance(Seffects.IGNITABLE,100,0));
        }
    }
