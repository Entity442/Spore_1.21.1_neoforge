...
public class Brute extends EvolvedInfected implements Carrier, RangedAttackMob, EvolvingInfected {
    ...
    public void tick() {
        ...
        if (getCarriedBlock() == null && tickCount % 80 == 0 && !level().isClientSide()){
    ...
    public void HyperEvolve(LivingEntity living) {
        ...
        if (this.level() instanceof ServerLevel serverLevel)
            ogre.finalizeSpawn(serverLevel,serverLevel.getCurrentDifficultyAt(this.getOnPos()), MobSpawnType.CONVERSION,null);
