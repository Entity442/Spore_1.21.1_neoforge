...
public class Howler extends EvolvedInfected implements VariantKeeper, ArmorPersentageBypass {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT = SynchedEntityData.defineId(Howler.class, EntityDataSerializers.INT);
    ...
    public void setVariant(int i) {
        this.entityData.set(DATA_ID_TYPE_VARIANT,i > HowlerVariants.values().length || i < 0 ? 0 : i);
    }
    ...
    public void ScreamBuffInfected(Entity origin) {
        ...
        Holder<MobEffect> effect = Utilities.tryToCreateEffect(ResourceLocation.parse(randomBuff));
    ...
    public void SummonScream(LivingEntity caster,boolean isSkulk,boolean sculkAround) {
        ...
        ResourceLocation entityId = ResourceLocation.parse(chosen);
