...
public class Scamper extends EvolvedInfected implements WaterInfected, VariantKeeper {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT = SynchedEntityData.defineId(Scamper.class, EntityDataSerializers.INT);
    ...
    protected SoundEvent getAmbientSound() {
        return Ssounds.SCAMPER_AMBIENT.value();
    }
