    ...
    private static class GorgonHybridAttackGoal extends Goal {
        ...
        public void tick() {
            ...
            if (!canShoot && gorgon.getSpores() > 6){
                gorgon.playSound(Ssounds.GORGON_SPEW.value());
                canShoot = true;
            }
        ...
        private void tryToApply(LivingEntity living, Holder<MobEffect> effect, int duration, int amp) {
