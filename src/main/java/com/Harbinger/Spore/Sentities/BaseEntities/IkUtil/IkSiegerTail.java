...
public class IkSiegerTail {
    ...
    protected final CalamityMultipart[] hitboxes;
    ...
    protected final static float size = 1f;
    ...
    public IkSiegerTail(Sieger owner, int amount, Vec3 defaultBodyOffset,
        ...
        owner.parts.addAll(Arrays.asList(hitboxes));
        owner.tail.addAll(Arrays.asList(hitboxes));
    ...
    public void applyIK() {
        ...
        if (!isOwnerMoving() || owner.calculateHeight()){
