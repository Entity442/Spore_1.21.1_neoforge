...
public class FleshBomb extends AbstractArrow {
    ...
    private void SummonInfected(ServerLevel serverLevel){
        ...
        ResourceLocation randomElement1 = ResourceLocation.parse(values.get(randomIndex));
        ...
        if (waveentity != null){
            ...
            waveentity.finalizeSpawn(serverLevel, this.level().getCurrentDifficultyAt(new BlockPos((int) this.getX(),(int)  this.getY(),(int)  this.getZ())), MobSpawnType.NATURAL,  null);
