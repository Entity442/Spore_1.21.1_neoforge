...
public class Umarmer extends Organoid implements VariantKeeper {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(HARD_ATTACK,false);
    ...
    public boolean isVehicle() {
        if (this.getFirstPassenger() != null){
            ...
            if (entity instanceof LivingEntity livingEntity){
                ...
                livingEntity.addEffect(new MobEffectInstance(Seffects.MYCELIUM,600,2),this);
    ...
    public boolean doHurtTarget(Entity entity) {
        if (entity instanceof LivingEntity livingEntity){
            ...
            livingEntity.addEffect(new MobEffectInstance(Seffects.MYCELIUM,600,1));
    ...
    protected SoundEvent getAmbientSound() {
        return Ssounds.UMARMER_AMBIENT.value();
    }
    ...
    public void setVariant(int i) {
        this.entityData.set(DATA_ID_TYPE_VARIANT,i > UmarmerVariants.values().length || i < 0 ? 0 : i);
    }
